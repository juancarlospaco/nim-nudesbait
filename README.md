...
- Make **Fake** *"Nudes"* folders using tiny Wikipedia images (3 per folder) on [NimScript](https://nim-lang.github.io/Nim/nims.html) to use it as harrasing wankers *"Bait"*.
...
- `nudesbait2.nim` can generate a standalone single-file native binary executable for Windows or Linux.
